export const prettyTime = (timeInSeconds: number) => {
	...
	// TODO: Add the calculation for hours
	...
	const minutes = formatTime(calculateMinutes(timeInSeconds));
	const seconds = formatTime(calculateSeconds(timeInSeconds, Number(minutes)));
